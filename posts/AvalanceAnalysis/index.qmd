...
#| message: false
#| warning: false
intergraphic = girafe(ggobj = p, width_svg = 4.5, height_svg = 5.5,options = list(opts_sizing(rescale = TRUE, width = .75)))

htmltools::save_html(intergraphic, "../../img/av_map.html")
```
